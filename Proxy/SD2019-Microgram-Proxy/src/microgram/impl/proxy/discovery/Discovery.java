package microgram.impl.proxy.discovery;
...
//			ds.joinGroup(DISCOVERY_ADDR.getAddress());
		...
		if (results.isEmpty())
			...
			Log.info(String.format("Discovery Results for: %s = %s", serviceName, results));
